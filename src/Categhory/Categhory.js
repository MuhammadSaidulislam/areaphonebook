...
import { allSubCategoryList, cardList, categoryList, subCategoryList } from "../api/auth";
          ...
          <div className="card categorySubcategory">
                  ...
                  <div className="cleartfix">
                    <div className="media align-items-stretch d-flex">
                      <div className="align-self-center">
                        <img className="manu-img" src={data.categoryImage} alt="image" />
                      </div>
                      <div className="media-body">
                        <h3 className="manu-item">
                          <Link to={`/narayanganj/${category.categoryName}`}>{category.categoryName}</Link>
                        </h3>
                        <Row>
                       
                          {category.subCategory && category.subCategory.slice(0, 3).map((subCategory) => 
                              <>
                                <span
                                  key={subCategory.id}
            ...
            <div id={category.categoryName} className="collapse">
              <Container>
                ...
                {category.subCategory && category.subCategory.map((subData) => (
                    <>
                      <Col xs={6}>
                        ...
                        <div className="media align-items-stretch d-flex">
                          ...
                          <div className="media-body">
                            ...
                            <Row>
                              ...
                              >
                                {" "}
                                <a href="#1" data-toggle="collapse" className="extra">
                                  আরো দেখুন{" "}
                                  <i className="fa fa-chevron-down"></i>
                                </a>{" "}
                              </span>
